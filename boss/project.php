                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="project_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="project_name" name="project_name" placeholder="News">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Plans<br>(Size: 600 X 400)</label>
                                        <div class="col-sm-4">
                                            <input type="file" id="image_title1" name="image_title1[]" multiple class="dropify" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="file" id="brochure_file" name="brochure_file" accept="application/pdf" class="dropify"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="file" id="legal_doc_file" name="legal_doc_file" accept="application/pdf" class="dropify"/>
                                        </div>
                                    </div>
